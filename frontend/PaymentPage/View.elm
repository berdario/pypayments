...
import Html.Attributes as Attr exposing (style, type_, name)
...
targetInt = customDecoder targetValue String.toInt
targetFloat = customDecoder targetValue String.toFloat
...
view model accounts = div []
    ...
    ,input [onInput SetAmount, type_ "number", Attr.min "0", Attr.max "1000", name "amount"] []
